...
// console.log(_obhect.이름);  // JS는 html 새로고침 /바뀌면 초기화 되므로 호출X
// _obhect is not defined


console.log(localStorage.getItem('회원정보목록'));
...
/*
    ...
    객체지향언어.
        문자열,객체,배열                                                                문자열만 저장이 가능.[객체저장불가]
        JS ----------------------localStorage.setItem(키 , JSON.stringify( 값 ) )------------------> 브라우저(저장)
            1. 기존에 있던 메모리 기억해야 되는데..                                       "1" vs 1
